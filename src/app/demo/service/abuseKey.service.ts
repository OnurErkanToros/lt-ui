...
export class AbuseKeyService {
    ...
    getAllAbuseKey(): Observable<AbuseDbKeyResponse[]> {
        return this.httpclient.get<AbuseDbKeyResponse[]>(
            this.apiUrl + 'get-all',
            { headers: this.authService.getHeaders() }
        );
    }
    addAbuseKey(
        abuseDbKeyRequest: AbuseDbKeyRequest
    ): Observable<AbuseDbKeyResponse> {
        return this.httpclient.post<AbuseDbKeyResponse>(
            this.apiUrl + 'add',
            abuseDbKeyRequest,
            { headers: this.authService.getHeaders() }
        );
